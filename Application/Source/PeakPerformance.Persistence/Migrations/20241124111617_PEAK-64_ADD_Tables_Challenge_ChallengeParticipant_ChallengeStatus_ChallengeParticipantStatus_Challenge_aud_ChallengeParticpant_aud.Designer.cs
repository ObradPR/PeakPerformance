...
namespace PeakPerformance.Persistence.Migrations
{
    ...
    [Migration("20241124111617_PEAK-64_ADD_Tables_Challenge_ChallengeParticipant_ChallengeStatus_ChallengeParticipantStatus_Challenge_aud_ChallengeParticpant_aud")]
    partial class PEAK64_ADD_Tables_Challenge_ChallengeParticipant_ChallengeStatus_ChallengeParticipantStatus_Challenge_aud_ChallengeParticpant_aud
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application.Challenge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application.ChallengeParticipant", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ChallengeParticipants", "dbo");
                });
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application_lu.ChallengeParticipantStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChallengeParticipantStatuses_lu", "dbo");
                });

            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application_lu.ChallengeStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChallengeStatuses_lu", "dbo");
                });
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Audits.ChallengeParticipant_aud", b =>
                {
                    ...
                    b.ToTable("ChallengeParticipants_aud", "dbo");
                });

            modelBuilder.Entity("PeakPerformance.Domain.Entities.Audits.Challenge_aud", b =>
                {
                    b.Property<long>("AuditId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application.Challenge", b =>
                {
                    b.HasOne("PeakPerformance.Domain.Entities.Application_lu.ChallengeStatus", "Status")
                        .WithMany("Challenges")
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application.ChallengeParticipant", b =>
                {
                    b.HasOne("PeakPerformance.Domain.Entities.Application.Challenge", "Challenge")
                        .WithMany("ChallengeParticipants")
                        .HasForeignKey("ChallengeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeakPerformance.Domain.Entities.Application_lu.ChallengeParticipantStatus", "Status")
                        .WithMany("ChallengeParticipants")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Audits.HealthInformation_aud", b =>
                {
                    b.HasOne("PeakPerformance.Domain.Entities.Application_lu.ActionType", "ActionType")
                        .WithMany("HealthInformation_aud")
                        .HasForeignKey("ActionTypeId");
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Audits.UserMeasurementPreference_aud", b =>
                {
                    b.HasOne("PeakPerformance.Domain.Entities.Application_lu.ActionType", "ActionType")
                        .WithMany("UserMeasurementPreference_aud")
                        .HasForeignKey("ActionTypeId");
            ...
            modelBuilder.Entity("PeakPerformance.Domain.Entities.Application_lu.ActionType", b =>
                {
                    b.Navigation("HealthInformation_aud");

                    b.Navigation("UserActivityLogs");

                    b.Navigation("UserMeasurementPreference_aud");

                    b.Navigation("UserRoles_aud");

                    b.Navigation("UserTrainingGoal_aud");

CREATE TABLE [dbo].[UserTrainingGoals] (
    ...
    CONSTRAINT [FK_UserTrainingGoals_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users] ([Id]) ON DELETE SET NULL
);
...
GO
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO UserTrainingGoals_aud (Id,UserId,CreatedOn,ModifiedOn,ModifiedBy,DeletedOn,DeletedBy,IsActive, ActionTypeId, DetailsJson)
                    SELECT
